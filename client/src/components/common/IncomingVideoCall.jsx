...
function IncomingVideoCall() {
  ...
  return <div className="h-24 w-80 fixed bottom-8 mv-0 right-6 z-50 rounded-xl flex gap-5 items-center justify-start p-4 bg-conversation-panel-background text-white drop-shadow-2xl py-14">
    <div>
      <Image 
