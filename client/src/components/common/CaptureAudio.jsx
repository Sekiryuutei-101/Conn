...
import { FaMicrophone, FaPauseCircle, FaPlay, FaStop, FaTrash, FaPause, FaPlayCircle } from "react-icons/fa";
...
function CaptureAudio({hide}) {
  ...
  <div className="flex text-2xl  w-full justify-end items-center">
    ...
    <div className="mx-4 py-3 px-4 text-white text-lg flex gap-3 justify-center items-center bg-search-input-container-background rounded-full drop-shadow-lg">
      {  isRecording ? (
